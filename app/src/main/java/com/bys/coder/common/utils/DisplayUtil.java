...
public class DisplayUtil {
     ...
     * 获取屏幕大小
     */
    public static int getDisplaySize(Context var0) {
        short var1 = 480;
        int var2 = ((Activity) var0).getWindowManager().getDefaultDisplay().getWidth();
        int var3 = ((Activity) var0).getWindowManager().getDefaultDisplay().getHeight();
